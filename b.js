...
(function () {
    ...
    function rezka2(component, _object) {
      ...
      function checkErrorForm(str) {
        ...
        var login_page = str && (str.indexOf('<div class="check-title">Вход</div>') !== -1 || /<title>\s*Вход\s*<\/title>/i.test(str)) && str.match(/<form id="check-form" class="check-form" method="post" action="\/ajax\/login\/">/);
    ...
    function component(object) {
      ...
      this.proxyStream = function (url, name) {
        if (url && use_stream_proxy) {
          ...
          if (name === 'rezka2') {
            return url.replace(/\/\/(stream\.voidboost\.(cc|top|link|club|one|net|tv)|[^\/]*.ukrtelcdn.net|vdbmate.org|sambray.org|rumbegg.org|laptostack.org|frntroy.org|femeretes.org)\//, rezka2_prx_ukr);
          }
        ...
        if (url && rezka2_fix_stream && name === 'rezka2') {
          return url.replace(/\/\/(stream\.voidboost\.(cc|top|link|club|one|net|tv)|[^\/]*.ukrtelcdn.net)\//, '//femeretes.org/');
        }
    ...
    function loadOnline(object) {
      ...
      checkMyIp(function () {
        checkCurrentFanserialsHost(function () {
          ...
          resetTemplates();
          Lampa.Component.add('online_boba', component);
          Lampa.Activity.push({
            url: '',
            title: Lampa.Lang.translate('online_mod_title_full'),
            component: 'online_boba',
            search: object.title,
    ...
    function initMain() {
      ...
      Lampa.Component.add('online_boba', component); //то же самое
      ...
      var button = "<div class=\"full-start__button selector view--online_boba\" data-subtitle=\"online_mod " + mod_version + "\">\n        <svg xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" xmlns:svgjs=\"http://svgjs.com/svgjs\" version=\"1.1\" width=\"512\" height=\"512\" x=\"0\" y=\"0\" viewBox=\"0 0 244 260\" style=\"enable-background:new 0 0 512 512\" xml:space=\"preserve\" class=\"\">\n        <g xmlns=\"http://www.w3.org/2000/svg\">\n            <path d=\"M242,88v170H10V88h41l-38,38h37.1l38-38h38.4l-38,38h38.4l38-38h38.3l-38,38H204L242,88L242,88z M228.9,2l8,37.7l0,0 L191.2,10L228.9,2z M160.6,56l-45.8-29.7l38-8.1l45.8,29.7L160.6,56z M84.5,72.1L38.8,42.4l38-8.1l45.8,29.7L84.5,72.1z M10,88 L2,50.2L47.8,80L10,88z\" fill=\"currentColor\"/>\n        </g></svg>\n\n        <span>#{online_mod_title}</span>\n        </div>";
      Lampa.Listener.follow('full', function (e) {
        if (e.type == 'complite') {
          var render = e.object.activity.render();
          if (render.find('.view--online_boba').length) return;
          var btn = $(Lampa.Lang.translate(button));
          online_loading = false;
          btn.on('hover:enter', function () {
            loadOnline(e.data.movie);
          });
          var after = render.find('.view--torrent');
          if (after.length) after.after(btn);
          else {
            after = render.find('.full-start__button').last();
            if (after.length) after.after(btn);
    ...
    function rezka2FillCookie(success, error) {
      var prox = Lampa.Platform.is('android') ? '' : Utils.proxy('rezka2');
      var prox_enc = '';
      var returnHeaders = androidHeaders;
      var proxy_mirror = Lampa.Storage.field('online_mod_proxy_rezka2_mirror') === true;
      var custom_mirror = (Lampa.Storage.get('online_mod_rezka2_mirror', '') + '').trim();
    ...
    function initSettings() {
      ...
      Lampa.Settings.listener.follow('open', function (e) {
        if (e.name == 'online_boba' || e.name == 'online_mod') {
